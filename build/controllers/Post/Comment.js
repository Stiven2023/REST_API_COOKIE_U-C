...
var commentController = /*#__PURE__*/function () {
  ...
  return _createClass(commentController, null, [{
    key: "getAll",
    value: // * Método para obtener todos los comentarios de una publicación
    function () {
      var _getAll = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request, response) {
        var postId, post, userIds, users, userMap, commentsWithUserData;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              // ! Obtener el ID de la publicación de los parámetros de la solicitud
              postId = request.params.postId; // ! Buscar la publicación por ID y seleccionar solo los comentarios
              _context.next = 4;
              return _Post["default"].findById(postId).select("comments");
            case 4:
              post = _context.sent;
              if (post) {
                _context.next = 7;
            ...
            case 7:
              ...
              userIds = post.comments.map(function (comment) {
            ...
            case 10:
              ...
              commentsWithUserData = post.comments.map(function (comment) {
                return {
                  _id: comment._id,
                  content: comment.content,
                  emoji: comment.emoji || "none",
                  // * Asegurarse de que el emoji está incluido
    ...
    key: "create",
    value: function () {
      var _create = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(request, response) {
        var token, decoded, userId, _request$body, content, _request$body$emoji, emoji, postId, user, post, comment;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 5:
              ...
              userId = decoded.id;
              _request$body = request.body, content = _request$body.content, _request$body$emoji = _request$body.emoji, emoji = _request$body$emoji === void 0 ? "none" : _request$body$emoji; // * Asegurarse de que el emoji está incluido
            ...
            case 10:
              // ! Obtener el ID de la publicación de los parámetros de la solicitud
              postId = request.params.postId; // ! Buscar el usuario por ID
              _context2.next = 13;
    ...
    key: "delete",
    value: function () {
      var _delete2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(request, response) {
        var token, decoded, userId, _request$params, postId, commentId, user, post, comment;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 4:
              ...
              decoded = _jsonwebtoken["default"].verify(token, _config["default"].secret);
              userId = decoded.id;
              _request$params = request.params, postId = _request$params.postId, commentId = _request$params.id; // ! Buscar el usuario por ID
              _context3.next = 9;
              return _User["default"].findById(userId);
            case 9:
              user = _context3.sent;

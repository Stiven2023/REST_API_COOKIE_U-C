...
var LikeController = /*#__PURE__*/function () {
  ...
  return _createClass(LikeController, null, [{
    key: "getAll",
    value: // * Método para obtener todos los likes de una publicación
    function () {
    ...
    key: "getMyLikePosts",
    value: function () {
      var _getMyLikePosts = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(request, response) {
        var token, decoded, userId, user, myLikes;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              token = request.headers["x-access-token"];
              decoded = _jsonwebtoken["default"].verify(token, _config["default"].secret);
              userId = decoded.id; //* Verifica si hay un token
              if (token) {
                _context2.next = 5;
                break;
              }
            ...
            case 5:
              user = _User["default"].findById(userId); //* Verifica si el usuario existe
              if (user) {
                _context2.next = 8;
                break;
              }
      ...
      function getMyLikePosts(_x3, _x4) {
        return _getMyLikePosts.apply(this, arguments);
      }
    ...
    key: "create",
    value: function () {
      var _create = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(request, response) {
        var token, decoded, userId, postId, like, post, validateLike, user;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 8:
              ...
              validateLike = post.likes.find(function (like) {
                return like.userId.equals(userId);
              });
              if (!validateLike) {
                _context3.next = 12;
                break;
    ...
    key: "delete",
    value: function () {
      var _delete2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(request, response) {
        var id, postId, post, deleteLike, user;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 5:
              ...
              deleteLike = post.likes.find(function (like) {
                return like._id.equals(id);
              });
              if (deleteLike) {
                _context4.next = 9;
                break;
              ...
              return _context4.abrupt("return", response.status(404).json({
                Error: "Like not found in the post"
              }));
            case 9:
            ...
            case 12:
              _context4.next = 14;
              return _User["default"].findById(deleteLike.userId);
            case 14:
              user = _context4.sent;
              user.likes = user.likes.filter(function (postId) {
                return !postId.equals(post._id);
              });
              _context4.next = 18;
              return user.save();
            case 18:
...
var _default = exports["default"] = LikeController;